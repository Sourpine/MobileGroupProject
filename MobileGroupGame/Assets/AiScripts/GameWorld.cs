...
public class GameWorld : MonoBehaviour
{
    ...
    public void DeckSelection(int deckPicked)
    {
        ...
        GameObject playerName = selection.gameObject.transform.Find("PlayerName").gameObject;
        if (playerName.gameObject.transform.Find("Text").GetComponent<Text>().text != string.Empty)
            playerHero.GetComponent<Hero>().AddHeroInfo(playerName.gameObject.transform.Find("Text").GetComponent<Text>().text);
        else
